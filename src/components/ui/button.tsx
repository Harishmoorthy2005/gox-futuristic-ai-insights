  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:scale-105 transition-spring shadow-glow font-semibold",
        premium: "bg-gradient-card border border-primary/20 text-foreground hover:border-primary/40 hover:shadow-glow transition-spring backdrop-blur-sm",
        cta: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-button font-semibold hover:scale-105 transition-spring",
      },
      size: {
